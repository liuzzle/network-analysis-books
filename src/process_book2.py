...
process_book('alice_preprocessing/text_analytics_alice/the_nursery_alice.txt', 'alice_chars.json', 'book2')
process_book('alice_preprocessing/text_analytics_alice/the_nursery_alice.txt', 'alice_chars.json', 'book2_no_alice', remove_character='alice')
