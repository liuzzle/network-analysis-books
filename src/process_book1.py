...
def process_book(original_text_file, char_json_path, output_prefix, remove_character=None):
    ...
    characters = []
    for character, aliases in characters_data["AliceInWonderland"]["characters"].items():
...
process_book('alice_preprocessing/text_analytics_alice/alices_adventures_in_wonderland.txt', 'alice_chars.json', 'book1')
process_book('alice_preprocessing/text_analytics_alice/alices_adventures_in_wonderland.txt', 'alice_chars.json', 'book1_no_alice', remove_character='alice')
process_book('alice_preprocessing/text_analytics_alice/alices_adventures_in_wonderland.txt', 'alice_chars.json', 'book1_no_two', remove_character='two')
process_book('alice_preprocessing/text_analytics_alice/alices_adventures_in_wonderland.txt', 'alice_chars.json', 'book1_no_pigeon', remove_character='pigeon')
